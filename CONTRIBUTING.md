...
We welcome contributions to **vscode-kubito**! This project is open source and we encourage community participation through **forks and pull requests**. All contributions must be made through the fork workflow - we do not accept direct pushes to the main repository.
...
1. **Fork the Repository**: Click the "Fork" button in the upper right corner of the [vscode-kubito repository](https://github.com/kubit-ui/vscode-kubito) on GitHub. This will create a copy of the repository in your GitHub account.
...
9. **Open a Pull Request**:
   - Go to the original [vscode-kubito repository](https://github.com/kubit-ui/vscode-kubito)
...
- Conventional commits like `feat(animation): add new walking animation for Kubito`
