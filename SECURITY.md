...
We actively support the following versions of vscode-kubito:
...
We take security vulnerabilities seriously. If you discover a security vulnerability in vscode-kubito, please report it to us responsibly.

### How to Report

1. **Email**: Send details to `security@kubit-ui.com`
2. **GitHub**: Create a private security advisory on GitHub
3. **Subject**: Include "Security Vulnerability - vscode-kubito" in the subject line
...
When using vscode-kubito:

1. **Keep Updated**: Always use the latest version
2. **Review Configuration**: Understand the extension configuration being applied
3. **Monitor Dependencies**: Watch for security advisories
4. **Validate Settings**: Test your extension settings regularly
